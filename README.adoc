...
* [.line-through]#Fallback to default if value isnt set# -> Done
* [.line-through]#Test fallback# -> Done
* Build 0.9 version
* Adjust config 
* [.line-through]#Ci specific stuff?# -> Handled via Enviroment variables
* Continue if dirty  ->  Also in dotnet build project
* test Dotnet versioning
