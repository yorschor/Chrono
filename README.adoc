...
WARNING: The Chrono.DotnetTasks package doesn't check if the working tree is clean while parsing a version.
This may lead to unexpected results if disregarded!

The Chrono.Cli however will warn you if you are working on a dirty working tree. link:doc/DotnetVersioning.adoc[Why?]
